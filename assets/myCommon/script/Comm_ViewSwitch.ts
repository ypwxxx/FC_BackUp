...
export default class ViewSwitch extends cc.Component {
    ...
    private _switchView(options: ViewSwitch_Options | string): void{
        ...
        if(name === 'main'){
            ...
            if(!isMoveIn){
                ...
                this._moveIn(name, moveInCallback, data);
                // 是否独显
                if(solo){
                    this._moveOutAllView(moveOutCallback);
                }
    ...
    // 移入
    private _moveIn(name: string, callback?: Function, data?: any):void{
        ...
        if(!view.instance){
            ...
            view.component = view.instance.getComponent(view.name);
            view.instance.parent = this.otherViewNode;
            view.instance.height = this.node.height;
            view.component && view.component.init && view.component.init();
        }else{
