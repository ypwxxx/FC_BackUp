...
//     public static getInstance(): Comm_Assets{
//         if(!this.instance){
//             this.instance = new Comm_Assets();
//         }
...
//     /**
//      * 添加资源组件
//      * @param key 改资源组件对应的key
//      * @param assets 资源组件
//      */
//     public addAssetsComponent(key: string, assets: Comm_AssetsComponent){
